...
/*
#cgo darwin LDFLAGS: -L${SRCDIR}/lib/darwin/lib -lheif -lde265 -lx265 -ldl  -lm -lstdc++
#cgo darwin CFLAGS:  -I${SRCDIR}/lib/darwin/include
*/

/*
#cgo darwin pkg-config: libheif
#cgo linux CFLAGS:  -I${SRCDIR}/lib/linux/include
#cgo linux LDFLAGS: -L${SRCDIR}/lib/linux/lib -lheif -lde265 -lx265 -ldl  -lm -lstdc++
#include <stdlib.h>
#include <stdint.h>
